...
[![Codecov test coverage](https://codecov.io/gh/jemarnold/epl/graph/badge.svg)](https://app.codecov.io/gh/jemarnold/epl)
<!-- badges: end -->
...
A rudimentary *"no-code"* implementation of some of the *{epl}* functions are available as [a *Shiny* app](https://jem-arnold.shinyapps.io/EPL-Parvo-App/) to read, clean, plot, and download Parvo metabolic data.

![9-panel plots available in the EPL Parvo app](C:/Users/Jem/Documents/Screenshots/2025-10/2025-10-29_22-25-16.jpg)
