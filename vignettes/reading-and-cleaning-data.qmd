...
- To perform digital filtering of metabolic data `<under development 0.2.0>`.

- To calculate peak values (e.g. V̇O~2~peak) `<under development 0.2.0>`.
...
::: {.callout-note}
`span = 30` sec is the default most common timespan for calculating V̇O~2~peak.
:::
